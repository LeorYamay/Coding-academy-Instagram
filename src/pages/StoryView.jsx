...
import { CommentSvg, EmojiSVG, HeartSvg, SaveSvg, ShareSvg, ThreeDotsSVG } from '../cmps/Svglist'
...
export function StoryView() {
    ...
    useEffect(() => {
        async function fetchStory() {
            const fetchedStory = await storyService.getById(params.storyId)
        ...
        <div className="story-view">
          <div className="story-info">
            ...
            <div className="story-info-text">
              <span className="username story-bold-link">
                {story.by.username}
              </span>
          ...
          <AddComment storyId={story._id} loggedInUserId={loggedInUser._id} />
        </div>
      </main>
    );
}
