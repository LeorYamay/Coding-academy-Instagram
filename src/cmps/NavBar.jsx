...
export function NavBar() {
    ...
    return (
        <nav className="nav-bar">
            ...
            <NavLink className='nav-item nav-home' key='home' to='' >
                <HomeSVG label = {"Home"} type = {"nav-home-icon"}/>
                <span className="nav-text">Home</span>
            </NavLink>

            <div className='nav-item' key={'search'}>
            ...
            <NavLink className='nav-item' key='explore' to='explore/' >
                <ExploreSVG label ={"Explore"} type ={"nav-explore-icon"}/>
                <span className="nav-text">Explore</span>
            </NavLink>

            <NavLink className='nav-item' key='reels' to='reels/' >
            ...
            <NavLink className='nav-item' key='messages' to='direct/inbox' >
                <MessagesSVG label={"Messenger"} type={"nav-messages-icon"} />
                <span className="nav-text">Messages</span>
            </NavLink>

            <div className='nav-item' key={'notifications'}>
                <HeartSvg label = "Notifications" type ="nav-notifications-icon"/>
                <span className="nav-text">Notifications</span>
            </div>

            <div className='nav-item' key={'create'}>
